    ...
    <div class="jumbotron">
        ...
        <table>
            <tr>
                ...
                <td class="container">
                    <div class="bg">
                        <a href="About.aspx"><asp:Image ID="Image1" runat="server" ImageUrl="~/img/bg1.jpg" Width="300px" /></a>
                    </div>
                    <div class="mid"><div class="line"><strong>▶▶▶<br />RESUME<br />PAGE<br />▶▶▶</strong></div></div>
                    <%--This is for hover--%>
                    <div class="head">
                ...
                <td class="container">
                    <div class="bg">
                        <a href="Contact.aspx"><asp:Image ID="Image2" runat="server" ImageUrl="~/img/bg1.jpg" Width="300px" /></a>
                    </div>
                    <a href="Contact.aspx"><div class="mid"><div class="line"><strong>▶▶▶<br />CONTACT PAGE<br />▶▶▶</strong></div></div></a>
                    <div class="head">
               ...
               <td class="container">
                    ...
                    <div class="mid"><div class="line"><strong>HELLO!</strong></div></div>
                    <div class="head">
